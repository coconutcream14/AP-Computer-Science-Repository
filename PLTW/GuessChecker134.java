  ...
  static Scanner sc = new Scanner(System.in);
    ...
    while(isCorrect){
      ...
      if(r1 == g1){
        ...
        System.out.println("Ooh close! The first digit you guessed is correct, but in place of the second digit.");
        nearHit++;
      }
      else if(g1 == r3){
        System.out.println("Ooh close! The first digit you guessed is correct, but in place of the third digit.");
        nearHit++;
      }
      else if(g1 == r4){
        System.out.println("Ooh close! The first digit you guessed is correct, but in place of the fourth digit.");
        nearHit++;
      }
      else {
      ...
      if(r2 == g2){
        ...
        System.out.println("Ooh close! The second digit you guessed is correct, but in place of the first digit.");
        nearHit++;
      }
      else if(g2 == r3){
        System.out.println("Ooh close! The second digit you guessed is correct, but in place of the third digit.");
        nearHit++;
      }
      else if(g2 == r4){
        System.out.println("Ooh close! The second digit you guessed is correct, but in place of the fourth digit.");
        nearHit++;
      }
      else {
      ...
      if(r3 == g3){
        ...
        System.out.println("Ooh close! The third digit you guessed is correct, but in place of the first digit.");
        nearHit++;
      }
      else if(g3 == r2){
        System.out.println("Ooh close! The third digit you guessed is correct, but in place of the second digit.");
        nearHit++;
      }
      else if(g3 == r4){
        System.out.println("Ooh close! The third digit you guessed is correct, but in place of the fourth digit.");
        nearHit++;
      }
      else {
