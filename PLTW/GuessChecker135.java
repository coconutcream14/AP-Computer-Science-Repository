...
public class GuessChecker135
{
  static Scanner sc = new Scanner(System.in);
    ...
    while(isCorrect){
      ...
      //Start of checking for digit 2
      if(r1 == g1){
          System.out.println("Yay! The first digit you guessed is correct.");
          firstDigit = true;
      }
      else if((g1 == r2) || (g1 == r3) || (g1 == r4)){
        System.out.println("Ooh close! The first digit you guessed is correct, but in the wrong place.");
        nearHit++;
      }
      ...
      if(r2 == g2){
        ...
        System.out.println("Ooh close! The second digit you guessed is correct, but in the wrong place.");
        nearHit++;
      }

      //Start of checking for digit 3
      ...
      if(r3 == g3){
        ...
        System.out.println("Ooh close! The third digit you guessed is correct, but in the wrong place.");
        nearHit++;
      }

      //Start of checking for digit 4
      ...
      if(r4 == g4){
        ...
        System.out.println("Ooh close! The fourth digit you guessed is correct, but in the wrong place.");
        nearHit++;
      }

      //Loops for incorrect guesses and for exiting the main while loop
      if((r1 != g1) || (r2 != g2) || (r3 != g3) || (r4 != g4)) {
          System.out.println("Oh no! The digits you guessed are incorrect.");
      }
